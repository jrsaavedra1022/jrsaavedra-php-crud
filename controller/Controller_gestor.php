...
class Controller_gestor {
	...
	public function view_edit(){
		...
		require_once('vistas/gestor/edit_user.php');
	}
	public function view_solicitudes (){
		$result = new ConnectionMySQL();
		$data_solicitudes = $result->consult_solicitudes();
		require_once('vistas/gestor/list_solicitudes.php');
	}
	public function register_user(){
			...
			if($bool){
				...
				echo "<script>
		                ...
		                window.location= '?controller=gestor&action=view'
		    			</script>";
			}else{
				//no registro
				echo "<script>
		                alert('El usuario no fue registrado');
		                window.location= '?controller=gestor&action=view_register'
		    			</script>";
			}
	}
	public function edit_user(){
			...
			if($bool){
				...
				echo "<script>
		                ...
		                window.location= '?controller=gestor&action=view_edit'
		    			</script>";
			}
	}
